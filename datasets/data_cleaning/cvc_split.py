...
if __name__ == '__main__':
    ...
    parser.add_argument('--origin_data_path', type=str,
                        default=r'F:\820\subject\dataset\MixSearch\CVC\Original')
    parser.add_argument('--origin_GT_path', type=str,
                        default=r'F:\820\subject\dataset\MixSearch\CVC\Ground Truth')
    parser.add_argument('--train_path', type=str,
                        default=r'F:\820\subject\dataset\MixSearch\CVC\train')
    parser.add_argument('--train_GT_path', type=str,
                        default=r'F:\820\subject\dataset\MixSearch\CVC\train_GT')
    parser.add_argument('--valid_path', type=str,
                        default=r'F:\820\subject\dataset\MixSearch\CVC\valid')
    parser.add_argument('--valid_GT_path', type=str,
                        default=r'F:\820\subject\dataset\MixSearch\CVC\valid_GT')
