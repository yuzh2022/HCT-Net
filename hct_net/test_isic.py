...
def main(args):
    ...
    args.model_list=['transformer_net0107_1']
    ...
    for model_name in args.model_list:
        if args.model == "transformer_net0107_1":
            ...
            args.model_path = '/content/drive/MyDrive/MIxSearch12.31_dynamic_transformer/nas_search/logs/cvc/transformer_2/model_best.pth.tar'
