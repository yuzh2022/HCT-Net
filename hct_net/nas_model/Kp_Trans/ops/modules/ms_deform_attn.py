...
class MSDeformAttn(nn.Module):
    ...
    def forward(self, query, reference_points, input_flatten, input_spatial_shapes, input_level_start_index,src_input, input_padding_mask=None):
        """
        ...
        #print("!!!!!!!input_spatial_shapes!!!!!!!",input_spatial_shapes.shape)
        ...
        if reference_points.shape[-1] == 2:
            offset_normalizer = torch.stack([input_spatial_shapes[..., 0],input_spatial_shapes[..., 1]], -1)
