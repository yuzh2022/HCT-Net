...
my_experiment_stage1_layer9_double_deep=Genotype(
    normal_down=[('max_pool', 1), ('shuffle_conv', 0), ('dep_conv', 0), ('max_pool', 1), ('shuffle_conv', 0), ('cweight', 3), ('max_pool', 1), ('cweight', 0)],
    normal_down_concat=range(2, 6),
    normal_up=[('shuffle_conv', 0), ('up_dil_conv', 1), ('dep_conv', 0), ('shuffle_conv', 2), ('shuffle_conv', 0), ('cweight', 3), ('up_dep_conv', 1), ('cweight', 0)],
    normal_up_concat=range(2, 6),
    normal_normal=[('shuffle_conv', 0), ('dep_conv', 1), ('dep_conv', 0), ('cweight', 1), ('dep_conv', 1), ('shuffle_conv', 0), ('cweight', 1), ('cweight', 0)], normal_normal_concat=range(2, 6))
