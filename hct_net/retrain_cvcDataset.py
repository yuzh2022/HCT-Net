...
def main(args):
    #################### init logger ###################################
    log_dir = './logs/' + '{}'.format(args.dataset) + '/{}_{}_{}'.format(args.model, args.note,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str,
                        choices=['layer7_double_deep', 'layer9_double_deep', 'stage1_double_deep',
                                 'stage1_nodouble_deep', 'transformer_net0106',
                                 ], default='ISIC_414',
    ...
    parser.add_argument('--train_batch', type=int, default=10, help="train_batch")
    parser.add_argument('--val_batch', type=int, default=10, help="val_batch ")
    ...
    parser.add_argument('--genotype_name', type=str, default="transformer_312_final", help="cell genotype")
