...
from utils import RefugeIndicatorsMetric,BinaryIndicatorsMetric,AverageMeter
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str,default='transformer_net0107_1',help='Model to train and evaluation')
